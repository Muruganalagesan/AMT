...
{
   public  class WMICompSysManager :WMIManagerBase 
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<CompSysInfo>(new CompSysInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
