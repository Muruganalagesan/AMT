...
{
    public class WMIQuickFixManager : WMIManagerBase
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> ReportTabs
        {
            get
            {
                return new List<string>() { "HotFixes", "Managment" };
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<QuickFixInfo>(new QuickFixInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }



        //public override List<T> FetchReportData<T> ()
        //{
