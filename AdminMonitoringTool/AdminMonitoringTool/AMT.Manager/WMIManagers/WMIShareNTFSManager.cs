...
{
    public class WMIShareNTFSManager : WMIManagerBase 
    {
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
