...
namespace AMT.Manager.WMIManagers
{
    ...
    public class WMIEnvironmentManager : WMIManagerBase
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<EnvironmentInfo>(new EnvironmentInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
