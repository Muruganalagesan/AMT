   ...
   public  class WMIShareManagercs : WMIManagerBase 
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<BiosInfo>(new BiosInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
