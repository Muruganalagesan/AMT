...
namespace AMT.Manager.WMIManagers
{
    ...
    public class WMINetworkLoginProfile : WMIManagerBase
    {

        //WMI Win32_NetworkLoginProfile
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override string WMIClass
        {
            get
            {
                return "Win32_NetworkLoginProfile";
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<NetworkLoginProfileInfo>(new NetworkLoginProfileInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
