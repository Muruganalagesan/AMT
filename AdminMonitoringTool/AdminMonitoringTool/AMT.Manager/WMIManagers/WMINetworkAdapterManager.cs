...
namespace AMT.Manager.WMIManagers
{
    ...
    //NetworkAdapter
    public class WMINetworkAdapterManager : WMIManagerBase
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<NetworkAdapterInfo>(new NetworkAdapterInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
