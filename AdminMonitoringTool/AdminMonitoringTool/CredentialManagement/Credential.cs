...
namespace AMT.CredentialManagement
{
    public class Credential: IDisposable
    {
        ...
        private void CheckNotDisposed()
        {
            ...
            AMTLogger.WriteToLog("CredentialsPrompt object is already disposed.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            }
        }
        ...
        public bool Save()
        {
            ...
            if (Password.Length > (512))
            {
                ...
                AMTLogger.WriteToLog("The password has exceeded 512 bytes.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            }
        ...
        public bool Exists()
        {
            ...
            if (string.IsNullOrEmpty(Target))
            {
                ...
                AMTLogger.WriteToLog("Target must be specified to check existance of a credential.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            }
