    ...
    public class VistaPrompt: BaseCredentialsPrompt
    {
        ...
        public string Domain
        {
            ...
            set
            {
                ...
                {
                   AMTLogger.WriteToLog("ArgumentOutOfRangeException", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
                }
                _domain = value;
            }
        }
        ...
        public override DialogResult ShowDialog(IntPtr owner)
        {
            ...
            {
            AMTLogger.WriteToLog("Title or Message should always be set.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            ...
            {
            AMTLogger.WriteToLog("This Operating System does not support this prompt.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            ...
            if (!string.IsNullOrEmpty(Username) || !string.IsNullOrEmpty(SecureStringHelper.CreateString(SecurePassword)))
            {
                ...
                if (Marshal.GetLastWin32Error() == 122)
                {
                    ...
                    AMTLogger.WriteToLog(Marshal.GetLastWin32Error()+"There was an issue with the given Username or Password.", MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
            ...
            {
            AMTLogger.WriteToLog("This functionality is not supported by this operating system." + e.Message , MethodBase.GetCurrentMethod().Name, 0, AMTLogger.LogInfo.Error);
