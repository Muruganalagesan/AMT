...
{
   public  class WMIBiosInfo :WMIActionBase 
    {
       

        List<BiosInfo> productInfoItems = new List<BiosInfo>();
        ...
        public override bool StoreData (DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<BiosInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData ()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<BiosInfo >(productInfoItems);
            }
            catch (Exception ex)
            {
