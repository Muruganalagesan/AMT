...
{
   public  class WMIEnvInfo :WMIActionBase 
    {

       List<EnvironmentInfo> productInfoItems = new List<EnvironmentInfo>();
        ...
        public override bool CollectReportData()
        {
            ...
            try
            {
              ...
              //  productInfoItems.Clear();
                ...
                {
                    EnvironmentInfo productInfo = new EnvironmentInfo() { };
        ...
        public override bool StoreData(DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<EnvironmentInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<EnvironmentInfo>(productInfoItems);
            }
            catch (Exception ex)
            {
