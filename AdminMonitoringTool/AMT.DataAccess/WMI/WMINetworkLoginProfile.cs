...
{
    public class WMINetworkLoginProfile : WMIActionBase 
    {
        List<NetworkLoginProfileInfo> productInfoItems = new List<NetworkLoginProfileInfo>();
        ...
        public override bool CollectReportData()
        {
            ...
            try
            {
               ...
               // productInfoItems.Clear();
                ...
                {
                    NetworkLoginProfileInfo productInfo = new NetworkLoginProfileInfo() { };
        ...
        public override bool StoreData(DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<NetworkLoginProfileInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<NetworkLoginProfileInfo>(productInfoItems);
            }
            catch (Exception ex)
            {
