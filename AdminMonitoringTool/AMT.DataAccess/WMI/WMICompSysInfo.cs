...
{
    public class WMICompSysInfo : WMIActionBase 
    {
      
        List<CompSysInfo> productInfoItems = new List<CompSysInfo>();
        ...
        public override bool CollectReportData ()
        {
            ...
            try
            {
              ...
              //  productInfoItems.Clear();
                ...
                {
                    CompSysInfo productInfo = new CompSysInfo() { };
        ...
        public override bool StoreData (DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<CompSysInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData ()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<CompSysInfo>(productInfoItems);

             //   result = AMT.Common.WMI.WMIQueryBuilder.FlipDataTable(result);
