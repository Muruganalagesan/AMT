...
{
    public class WMINetworkAdapter : WMIActionBase 
    {
        List<NetworkAdapterInfo> productInfoItems = new List<NetworkAdapterInfo>();
        ...
        public override bool StoreData(DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<NetworkAdapterInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<NetworkAdapterInfo>(productInfoItems);
            }
            catch (Exception ex)
            {
