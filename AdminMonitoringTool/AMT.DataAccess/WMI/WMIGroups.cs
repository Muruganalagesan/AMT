...
{
    public class WMIGroups : WMIActionBase 
    {
        List<GroupAccountInfo> productInfoItems = new List<GroupAccountInfo>();
        ...
        public override bool StoreData(DbStorageBase inputType, WMIConnectionInfo ConnectionInfo)
        {
            ...
            try
            {
                ...
                inputType.StoreData<GroupAccountInfo>(productInfoItems, ConnectionInfo);
        ...
        public override DataTable GetReportData()
        {
            ...
            try
            {
                result = AMT.Common.WMI.WMIQueryBuilder.ToDataTable<GroupAccountInfo>(productInfoItems);
            }
            catch (Exception ex)
            {
