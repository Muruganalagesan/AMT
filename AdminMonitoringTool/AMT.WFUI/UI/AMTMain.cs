...
using AMT.WFUI.UI.Wizards.RemoteShutDownWizard;
using AMT.WFUI.UI.Wizards.ScheduleWizard;
namespace AMT.WFUI
{
    public partial class AMTMain : Form
    {
        ...
        {
            ScheduleWizard scheduleWizard = new ScheduleWizard();
            scheduleWizard.ShowDialog(this);
        }
        ...
        private void remoteActionSettingsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            RemoteSettings remoteSettings = new RemoteSettings();
            remoteSettings.ShowDialog(this);
        }
        ...
        private void sharePermissionsNTFSToolStripMenuItem_Click(object sender, EventArgs e)
        {
