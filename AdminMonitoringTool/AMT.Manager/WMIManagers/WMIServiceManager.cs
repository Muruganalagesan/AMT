...
{
    public class WMIServiceManager : WMIManagerBase
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass ;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.Database)+  ") values(" + WMIQueryBuilder.GetQuery<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@")  + ")";
            }
        ...
        public override List<string> ReportTabs
        {
            get
            {
                return new List<string>() { "Services", "Managment" };
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<ServiceInfo>(new ServiceInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
