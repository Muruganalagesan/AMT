...
{
  public   class WMILogicalDiskManager :WMIManagerBase
    {
        ...
        public override string TableQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetReportQuery<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " from " + TableName;
            }
        ...
        public override string WMIQuery
        {
            get
            {
                return "Select " + WMIQueryBuilder.GetQuery<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI) + " from " + WMIClass;
            }
        ...
        public override List<string> WMIFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.WMI);
            }
        ...
        public override List<string> DatabaseFields
        {
            get
            {
                return WMIQueryBuilder.GetProperties<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        ...
        public override string InsertQuery
        {
            get
            {
                return "Insert into " + TableName + "(" + WMIQueryBuilder.GetQuery<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.Database) + " ) values(" + WMIQueryBuilder.GetQuery<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.Database, "@") + ")";
            }
        ...
        public override List<string> ReportTabs
        {
            get
            {
                return new List<string>() { "Disk", "Managment" };
            }
        ...
        public override List<string> CustomFields
        {
            get
            {
                ...
                return WMIQueryBuilder.GetFields<LogicalDiskInfo>(new LogicalDiskInfo(), ReportingInterfaces.EnumHelper.QueryType.Database);
            }
        }
